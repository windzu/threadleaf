 ...
 * all providers: Windy settings and page conversation metadata.
 *
...
export interface SharedAppStorage {
  initialize(): Promise<{ windy: Record<string, unknown> }>;
  saveWindySettings(settings: Record<string, unknown>): Promise<void>;
